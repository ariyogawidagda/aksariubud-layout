...
export default function Navbar({ setOpen, slug }) {
      ...
      if (ref.current) {
        ...
        if (isMobile) {
          if (currentScrollPosition > previousScrollPosition) {
            ref.current.classList.add("bg-[#FAB766]", "shadow-md");
          } else {
            if (currentScrollPosition === 0) {
              ref.current.classList.remove("bg-[#FAB766]", "shadow-md");
            } else {
              ref.current.classList.add("bg-[#FAB766]", "shadow-md");
            }
          }
          ...
          if (scrollTop > 50) {
            ...
            refButton?.current?.classList.remove("hover:bg-[#FAB766]");
            ...
            refButton?.current?.classList.add("hover:bg-[#FAB766]");
            refButton?.current?.classList.add(
              "hover:border-[var(--headerColor)]",
            );
          }
  ...
  return (
    <>
      <nav
        ref={ref}
        className="bg-[#FAB766] fixed w-full h-fit inset-0 z-[100] duration-500 ease-in-out "
      >
        <div
