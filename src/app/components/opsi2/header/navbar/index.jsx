...
export default function Navbar({ setOpen, slug }) {
      ...
      if (ref.current) {
        ...
        if (isMobile) {
          if (currentScrollPosition > previousScrollPosition) {
            ref.current.classList.add("bg-[#F7CD9B]", "shadow-md");
          } else {
            if (currentScrollPosition === 0) {
              ref.current.classList.remove("bg-[#F7CD9B]", "shadow-md");
            } else {
              ref.current.classList.add("bg-[#F7CD9B]", "shadow-md");
            }
          }
          ...
          if (scrollTop > 50) {
            ...
            refButton?.current?.classList.remove("hover:bg-[#F7CD9B]");
            ...
            refButton?.current?.classList.add("hover:bg-[#F7CD9B]");
            refButton?.current?.classList.add(
              "hover:border-[var(--headerColor)]",
            );
          }
  ...
  return (
    <>
      <nav
        ref={ref}
        className="bg-[#F7CD9B] fixed w-full h-fit inset-0 z-[100] duration-500 ease-in-out "
      >
        <div
