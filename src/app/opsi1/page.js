import Awards from "../components/opsi1/awards";
import CtaOffers from "../components/ctahome";
import Facilities from "../components/opsi1/facilities";
import Footer from "../components/opsi1/footer";
import Gallery from "../components/opsi1/gallery";
import Header from "../components/opsi1/header";
import Hero from "../components/hero";
import Media from "../components/media";
import Offers from "../components/opsi1/offers";
import GuestReviews from "../components/opsi1/review";
import RoomV2 from "../components/roomv2";
// import Room from "./components/rooom";
import SectionBookM from "../components/sectionbook";
export default function HomePageOpsi1() {
  return (
    <>
      <Header />
      <main className="bg-[#FAB766]">
        <Hero />
        <Awards />
        <section className="bg-[#FAB766] pb-[120px] max-[560px]:pb-[80px]">
        ...
        <section className="bg-[#FAB766] pb-[100px] max-[560px]:pb-[80px]">
