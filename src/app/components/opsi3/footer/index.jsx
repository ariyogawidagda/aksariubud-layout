  ...
  return (
    <>
      <footer className="py-[40px] pt-[90px] relative">
        ...
        <div className="absolute inset-0 bg-[#F4AE7A]"></div>
          ...
          <div className="grid grid-cols-12 ">
            ...
            <div className=" max-[768px]:mt-[40px] col-span-3 max-[560px]:col-span-12">
              ...
              <div className="mt-[40px] flex gap-[10px] max-[560px]:justify-center">
                <a
                  href={"#"}
                  className=" w-[30px] h-[30px] rounded-[50%] bg-[#bd753f] flex justify-center items-center"
      ...
      <div className="py-[40px] px-[38px] bg-[#F4AE7A]">
