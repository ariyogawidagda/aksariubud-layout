import Awards from "../components/opsi4/awards";
import CtaOffers from "../components/ctahome";
import Facilities from "../components/opsi4/facilities";
import Footer from "../components/opsi4/footer";
import Gallery from "../components/opsi4/gallery";
import Header from "../components/opsi4/header";
import Hero from "../components/hero";
import Media from "../components/media";
import Offers from "../components/opsi4/offers";
import GuestReviews from "../components/opsi4/review";
import RoomV2 from "../components/roomv2";
// import Room from "./components/rooom";
import SectionBookM from "../components/sectionbook";
export default function HomePageOpsi4() {
  return (
    <>
      <Header />
      <main className="bg-[#F7BD97]">
        <Hero />
        <Awards />
        <section className="bg-[#F7BD97] pb-[120px] max-[560px]:pb-[80px]">
        ...
        <section className="bg-[#F7BD97] pb-[100px] max-[560px]:pb-[80px]">
